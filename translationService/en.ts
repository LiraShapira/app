...
const enDictionary: Dictionary = {
  ...
  deposit_modal_button_correct: 'correct the amount',
  ...
  send_flow_header_who: 'Who',
  send_flow_header_how_much: 'How Much',
  send_flow_header_why: 'Why',
  ...
  sendamount_validate_amount: 'Please input a number between 1 - 1000',
